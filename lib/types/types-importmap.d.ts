 ...
 */
export type SRIAlg = 'sha256' | 'sha384' | 'sha512';
/**
 *
 ...
 */
export declare function encodeSRI(alg: SRIAlg, data: ArrayBuffer | ArrayBufferView): Promise<{
    sri: SRI;
    hash: ArrayBuffer;
}>;
/**
 ...
 */
export declare function decodeSRI(sri: SRI): Promise<{
    alg: string;
    hash: Uint8Array;
}>;
/**
 ...
 */
export declare function verifySRI(sri: SRI, data: ArrayBuffer | ArrayBufferView): Promise<boolean>;
